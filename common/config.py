...
def _add_test_args(parser):
    parser.add_argument('--test_file', default='./data/turk/test.bin', type=str, help='path to the test set file')
...
def _add_train_args(parser):
    ...
    parser.add_argument('--asdl_file', default='./data/turk/turk_asdl.txt', type=str, help='Path to ASDL grammar specification')
    parser.add_argument('--vocab', default='./data/turk/vocab.bin', type=str, help='Path of the serialized vocabulary')
    parser.add_argument('--save_to', type=str, default='./checkpoints/logs.pt', help='save the model to')
    parser.add_argument('--train_file', default='./data/turk/train.bin', type=str, help='path to the training target file')

    parser.add_argument('--dev_file', default='./data/turk/dev.bin',  type=str, help='path to the dev source file')
    ...
    parser.add_argument('--max_epoch', default=1, type=int, help='max epoch')
